...
const Header = () => {
    ...
    return (
        <header className="flex  py-4 px-4 sm:px-10 bg-black font-[sans-serif] min-h-[70px] tracking-wide relative z-50">
            <div className="flex flex-wrap items-center justify-between gap-4 w-full">
                ...
                <div className="flex items-center ml-auto space-x-6">
                    ...
                    <button className="px-4 py-2 text-sm rounded-sm font-bold text-white border-2 border-[#FFA726]  transition-all ease-in-out duration-300 hover:bg-[#FFA726] hover:text-black">
