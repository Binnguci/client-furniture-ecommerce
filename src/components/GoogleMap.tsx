...
function GoogleMap() {
    return (
        <div className="h-[30rem] w-full flex items-center justify-center ">
            ...
            >
                <div className="flex basic-full w-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 h-[20rem]">
                    <h3 className="max-w-xs !pb-2 !m-0 font-bold  text-base text-[#FFA726] ">
                  ...
                  Đến ngay cửa hàng của chúng tôi để trải nghiệm dịch vụ tốt nhất
                    ...
                    <div
                        ...
                        <iframe className={"flex-grow"}
                            ...
                            width="1060px" height="200px" allowFullScreen={true} loading="lazy"
