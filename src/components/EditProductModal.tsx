...
interface EditProductModalProps {
    ...
    onClose: () => void;
    onSave: (updatedProduct: ProductUpdate) => void;
}
    ...
    const onFinish = async (values: ProductUpdate) => {
        ...
        try {
            ...
            if (response.data?.code === 200) {
                ...
                const updatedProductRequest: ProductUpdate = {
