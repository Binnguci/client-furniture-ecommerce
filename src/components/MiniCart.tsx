                ...
                <div className="p-4">
                    ...
                    <ul className="max-h-60 overflow-y-auto" style={{
                        ...
                        {cart.cartItemResponse.map((item) => (
                            <Link to={`/product/${item.productDTO.id}`}>
                    ...
                    <div className="mt-4">
                        <Link to="/cart">
                            <button
                                className="w-full bg-[#FFA726] hover:bg-black text-black font-bold hover:text-[#FFA726] py-2 rounded transition-colors duration-300">
